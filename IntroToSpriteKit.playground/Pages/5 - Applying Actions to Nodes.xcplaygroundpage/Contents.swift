...
// Make the first circle wait 20 seconds, and move to the right
let actionLongWaitThenMoveRight = SKAction.sequence([actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionRightMovement])

circle1.run(actionLongWaitThenMoveRight)
